...
VALUES
  (@profile_id, 'Lubricantes Claudia', 'Practicante en Desarrollo de Software', 'Callao, Perú', '2025-08-01', NULL, TRUE,
   CONCAT(
     'Desarrollo de aplicaciones con Java (Spring Boot).', CHAR(10),
